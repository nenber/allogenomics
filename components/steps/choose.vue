    ...
    <el-col :span="8">
      ...
      >
        <div class="card-content">
          ...
          <h2>Allogenomics insights into <b>one</b> cohort</h2>
        </div>
      </el-card>
    </el-col>
  </el-row>
