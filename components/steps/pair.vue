      ...
      <div class="card-body">
        ...
        >
          ...
          <div class="el-upload__text">
            Drop here the recipient VCF <br> or <br><em>click to upload</em>
          </div>
          <template #tip>
...
const handleChangeRecipient = (file, fileList) => {
...
const handleChangeDonor = (file, fileList) => {
...
const acceptedFileTypes = ".vcf,.vcf.gz";
